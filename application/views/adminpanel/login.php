				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form action="<?=URL?>admin_index/logincheck" method="post">
								<?php if(isset($this->msg)){ ?>
									<h6 class="text-danger"><?=$this->msg?></h6>
								<?php } ?>
                <div class="form-group m-form__group">
                  <input class="form-control m-input m-login__form-input--last" type="text" placeholder="Enter Email" name="username">
                </div>
								<div class="form-group m-form__group">
